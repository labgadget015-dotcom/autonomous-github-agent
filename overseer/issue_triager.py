...
class IssueTriager:
    ...
    def __init__(self, repo_path: Path, config: Dict):
        ...
        self.label_patterns = {
            'bug': [
                r'\bbug\b', r'\berror\b', r'\bcrash\b', r'\bfail(s|ed|ure)?\b',
                r'\bbroken\b', r'\bnot working\b', r'\bissue\b'
            ],
            'enhancement': [
                r'\bfeature\b', r'\benhancement\b', r'\bimprovement\b',
                r'\badd\b', r'\bwould be nice\b', r'\brequest\b'
            ],
            'documentation': [
                r'\bdoc(s|umentation)?\b', r'\breadme\b', r'\bguide\b',
                r'\btutorial\b', r'\bexample\b'
            ],
            'performance': [
                r'\bperformance\b', r'\bslow\b', r'\boptimiz(e|ation)\b',
                r'\bspeed\b', r'\bfaster\b'
            ],
            'security': [
                r'\bsecurity\b', r'\bvulnerability\b', r'\bexploit\b',
                r'\bCVE\b', r'\bXSS\b', r'\bSQL injection\b'
            ],
            'dependencies': [
                r'\bdependenc(y|ies)\b', r'\bpackage\b', r'\bupgrade\b',
                r'\bversion\b', r'\brequirements\b'
            ],
            'ci/cd': [
                r'\bCI\b', r'\bCD\b', r'\bworkflow\b', r'\baction\b',
                r'\bbuild\b', r'\bdeploy(ment)?\b'
            ],
            'testing': [
                r'\btest(s|ing)?\b', r'\bcoverage\b', r'\bunit test\b',
        ...
        self.priority_patterns = {
            'critical': [
                r'\bcritical\b', r'\bsever(e|ity)\b', r'\bproduction\b',
                r'\bdown\b', r'\bblocking\b', r'\bsecurity\b'
            ],
            'high': [
                r'\burgent\b', r'\bimportant\b', r'\basap\b',
                r'\bbreaking\b', r'\bmajor\b'
            ],
            'medium': [
                r'\bmoderate\b', r'\bnormal\b', r'\bshould\b'
            ],
            'low': [
                r'\bminor\b', r'\bnice to have\b', r'\bwould like\b',
                r'\beventually\b', r'\bsomeday\b'
            ]
        }
    ...
    def process(self) -> Dict[str, Any]:
        ...
        logger.info(f"Issue triage complete. Detected {len(results['patterns'])} patterns")
