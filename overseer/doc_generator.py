...
class DocumentationGenerator:
    ...
    def _build_readme_content(self) -> str:
        ...
        sections.append("")
        sections.append(f"This repository provides {', '.join(self.repo_info['frameworks']) if self.repo_info['frameworks'] else 'a software solution'}.")
        sections.append("")
        ...
        sections.append(f"git clone https://github.com/your-org/{self.repo_info['name']}.git")
        ...
        sections.append("")
        sections.append("See [CONTRIBUTING.md](CONTRIBUTING.md) for guidelines on how to contribute.")
        sections.append("")
    ...
    def _build_contributing_content(self) -> str:
        ...
        sections.append("2. Clone your fork: `git clone https://github.com/your-username/repo-name.git`")
        sections.append("3. Create a feature branch: `git checkout -b feature/amazing-feature`")
        sections.append("")
