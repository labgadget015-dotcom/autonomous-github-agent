...
def test_config_generation():
    ...
    try:
        ...
        print(f"  • Require PR reviews: {config.get('require_pull_request_reviews', {}).get('required_approving_review_count')} approval(s)")
        print(f"  • Dismiss stale reviews: {config.get('require_pull_request_reviews', {}).get('dismiss_stale_reviews')}")
        print(f"  • Require status checks: {config.get('require_status_checks', {}).get('strict')}")
