...
async function handleCheckoutComplete(session: Stripe.Checkout.Session) {
  ...
  // TODO: write to DB — mark customer as active Growth tier
  // await db.subscriptions.upsert({ customerId, subscriptionId, status: "active", tier: "growth" });
...
async function handlePaymentFailed(invoice: Stripe.Invoice) {
  ...
  // TODO: send dunning email / update access
}
