    ...
    try:
        ...
        if analyses:
            ...
            if code:
                ...
                print(
                    f"    - Refactoring Opportunities: {len(code.get('refactoring_opportunities', []))}"
                )
                print(
                    f"    - Architectural Improvements: {len(code.get('architectural_improvements', []))}"
                )
                print(
                    f"    - Performance Issues: {len(code.get('performance_optimizations', []))}"
                )
            ...
            if deps:
                ...
                print(
                    f"    - Outdated Packages: {len(deps.get('outdated_packages', []))}"
                )
                print(
                    f"    - Upgrade Recommendations: {len(deps.get('upgrade_recommendations', []))}"
                )
            ...
            if cicd:
                ...
                print(
                    f"    - Test Improvements: {len(cicd.get('test_improvements', []))}"
                )
