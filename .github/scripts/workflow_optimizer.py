...
class WorkflowOptimizer:
    ...
    def generate_optimization_report(self) -> str:
        ...
        # Summary
        report += "## Summary\n\n"
        total_recs = (len(duration_analysis.get('recommendations', [])) + 
    ...
    def estimate_cost_savings(self, current_duration: int, optimized_duration: int, 
                             runs_per_day: int = 50) -> Dict:
