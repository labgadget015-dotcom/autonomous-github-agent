...
class MetricsCollector:
    ...
    def record_workflow_duration(
        self, workflow_name: str, job_name: str, duration: float
    ):
...
def main():
    ...
    parser.add_argument(
        "--workflow-name", type=str, default="ci_pipeline", help="Name of the workflow"
    )
    parser.add_argument(
        "--job-name", type=str, default="metrics_collection", help="Name of the job"
    )
    ...
    parser.add_argument(
        "--push", action="store_true", help="Push metrics to Pushgateway"
    )
    parser.add_argument(
        "--dashboard-output", type=Path, help="Output file for dashboard data"
    )
    ...
    if args.duration:
        collector.record_workflow_duration(
            args.workflow_name, args.job_name, args.duration
        )

    collector.record_workflow_result(args.workflow_name, args.job_name, args.success)
