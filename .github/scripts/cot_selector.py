...
class OptimizedCoTSelector:
    ...
    DOC_PATTERNS = {".md", ".txt", ".rst", ".adoc", "README", "LICENSE", "CHANGELOG"}
    ...
    def _load_config(self) -> Dict:
        ...
        return {
            "ai_agent": {
                "cot_selection": {
                    "complexity_thresholds": {"simple": 0.3, "moderate": 0.6}
                }
            }
        }
...
if __name__ == "__main__":
    ...
    for test in test_contexts:
        ...
        print(
            f"Token savings: {savings['tokens_saved']} ({savings['reduction_percentage']:.0f}%)"
        )
